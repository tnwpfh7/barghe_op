...
if [ ! -f "/system/fonts/NanumGothic.ttf" ]; then
    ...
    cp -f /data/openpilot/common/AccessToken /data/params/d
    cp -f /data/openpilot/common/Dongleld /data/params/d
    chmod 644 /system/etc/fonts.xml
    chmod 644 /system/fonts/NanumGothic*
    chmod 666 /data/parms/d/AccessToken
    chmod 666 /data/parms/d/Dongleld
